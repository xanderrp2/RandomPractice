...
def GaMe():
    ...
    while True:
        pygame.draw.rect(screen,(255,0,0),(800,800,100,100),5)
...
print("hello do you whant to play a game?")
AAA = input()
...
if AAA == "yes" or AAA == "y" or AAA == "Yes" or AAA == "Y":
    GaMe()
